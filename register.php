                        ...
                        <div class="col-xl-8 col-lg-9">
                            <div class="card my-5">
                                <div class="card-body p-5 text-center">
                                    ...
                                    <a class="btn btn-icon btn-github mx-1" href="javascript:void(0);">
                                        <i class="fab fa-github fa-fw fa-sm"></i>
                                    </a>
                                    <a class="btn btn-icon btn-google mx-1" href="javascript:void(0);">
                                        <i class="fab fa-google fa-fw fa-sm"></i>
                                    </a>
                                    <a class="btn btn-icon btn-twitter mx-1" href="javascript:void(0);">
                                        <i class="fab fa-twitter fa-fw fa-sm"></i>
                                    </a>
                                </div>
                                <hr class="my-0" />
                                    ...
                                    <form>
                                        ...
                                        <div class="form-group d-flex align-items-center justify-content-between">
                                            <div class="custom-control custom-control-solid custom-checkbox">
                                                ...
                                                <label class="custom-control-label mr-3" for="customCheck1">I accept the 
                                ...
                                <div class="card-body px-5 py-4">
                                    <div class="small text-center">Have an account? 
                                        <a href="login-social.php">Sign in!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
